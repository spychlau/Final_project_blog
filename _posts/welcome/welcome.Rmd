---
title: "Welcome to Final Project Blog"
description: |
  Welcome to my blog on visualizing correlations in survey data.
author:
  - name: Sophie Pychlau
...
This project uses data synthesized from the pilot survey to play with various ways to introduce readers to survey data and the correlations between variables. The target audience is an interested reader with basic knowledge of survey data. All visualizations and tables serve the purpose of familiarizing oneself with the data before hypotheses get tested.